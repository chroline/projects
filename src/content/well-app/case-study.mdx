...
I wanted The Well App to be able to make an actual impact on people's lives and *actually* be helpful, not just another journaling or self-reflection app. To do so, I researched a lot about the field of positive psychology and the science of well-being. If you are interested in learning more about the science behind The Well App and seeing some of the resources I used, jump to the [Research page](/well-app).

## Original pitch

This project was originally created as a winning entry for a Hackathon; as such, I preserved the original pitch for the project. If you are interested in viewing it, you can do so here: [https://projects.colegaw.in/well-app/pitch.pdf](https://projects.colegaw.in/well-app/pitch.pdf).
