...
This was my first time working with a cross-platform app development framework, and it really was a great experience. Although the app doesn't always run as smoothly as a native app would, 9 times out of 10 this isn't noticable.
